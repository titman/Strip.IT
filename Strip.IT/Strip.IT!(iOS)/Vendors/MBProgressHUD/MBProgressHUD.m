...
static const CGFloat MBDefaultPadding = 10;
static const CGFloat MBDefaultLabelFontSize = 18.;
static const CGFloat MBDefaultDetailsLabelFontSize = 16.;
...
- (void)setupViews {
    ...
    label.font = [UIFont systemFontOfSize:(MBDefaultLabelFontSize)];//[UIFont boldSystemFontOfSize:MBDefaultLabelFontSize];
    label.opaque = NO;
